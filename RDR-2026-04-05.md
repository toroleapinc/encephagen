...
3. Body physics too stable (doesn't challenge the brain)
4. E-prop doesn't learn at this scale (task too hard)

**What works:** SC-FC validation (r=0.42), timescale hierarchy (r=-0.45), feedforward inhibition, CPG locomotion, interactive demo.

**Next realistic step:** Wire to MuJoCo Walker2d (properly unstable) with BT-SNN approach (connectome as RL architecture, region-specific tau_m), testing motor learning speed.

---

*Day 5. 32 experiments. The honest answer: macro-scale dMRI is insufficient for cognitive advantage, but the infrastructure for a working brain-body system is complete.*
